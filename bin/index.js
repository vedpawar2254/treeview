...
Examples:
  ...
  return { additionalFiles, additionalPatterns,dirsOnly };
}

// Parse arguments and run tree
const { additionalFiles, additionalPatterns,dirsOnly } = parseArgs();
runTree(process.cwd(), additionalFiles, additionalPatterns,dirsOnly);
